...
| 部门 | 古代职责 | AI 职责 | 典型场景 |
|------|----------|---------|----------|
| **司礼监** | 皇帝近侍、批红 | 总管调度 | 日常对话、任务分配、自动汇报 |
| **兵部** | 军事武备 | 软件工程 | 写代码、架构设计、代码审查、Bug 调试 |
| **户部** | 户籍财税 | 财务运营 | 成本分析、预算管控、电商运营 |
| **礼部** | 礼仪外交 | 品牌营销 | 文案创作、社媒运营、内容策划 |
| **工部** | 工程营造 | 运维部署 | DevOps、CI/CD、服务器管理 |
| **吏部** | 官员选拔 | 项目管理 | 创业孵化、任务追踪、团队协调 |
| **刑部** | 司法刑狱 | 法务合规 | 合同审查、知识产权、合规检查 |
